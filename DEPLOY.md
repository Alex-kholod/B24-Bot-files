...
2. **Файл и пункт чек-листа.** Файл должен появиться во вкладке «Файлы» задачи с настоящим
   именем, а пункт чек-листа — содержать дату и гиперссылку с именем файла.
